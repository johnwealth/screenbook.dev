        ...
        <div class="container">
            ...
            <div class="container text-center">
              ...
              <div class="title text-center">
                   <a href="{{ url('https://www.facebook.com/ScreenBook.Ng/')}}"><i class="fa     fa-facebook"></i></a>
                        <a href="{{ url('https://twitter.com/screenbook_ng')}}"><i class="fa fa-twitter"></i></a>
    ...
    <div class="col-lg-12 ">
      ...
      <div class="col-md-3">
        <ul>
          ...
          <li><a href="{{url('https://screenbooktutoring.slack.com')}}">Slack channel </a></li>
        </ul>
      </div>
      <div class="col-md-3">
        <ul>
